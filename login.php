...
<body>
    <div class="wrapper">
        <h1><a href="index.php"><img src="images\pineapple.png" alt="logo"></a> Login</h1>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <p>Please fill in your credentials to login.</p><br><br>
            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                <label>Username</label><br>
                <input type="text" name="username" class="form-control" value="<?php echo $username; ?>" autofocus autocomplete="off"><br>
